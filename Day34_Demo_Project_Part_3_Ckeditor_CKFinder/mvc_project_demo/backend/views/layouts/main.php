...
Cách ghép layout từ template tĩnh
- Với template AdminLTE, copy nội dung
file sau: mockup_html/backend/index.html
- Copy các thư mục liên quan của template như:
